 ...
 */
final class Version20231002115829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, commentaire VARCHAR(255) NOT NULL, date_review DATETIME NOT NULL, rating INT NOT NULL, INDEX IDX_794381C667B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
