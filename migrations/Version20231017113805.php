 ...
 */
final class Version20231017113805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, isbn VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, date_edition DATETIME NOT NULL, number_pages VARCHAR(255) NOT NULL, resume VARCHAR(255) NOT NULL, thumbnail VARCHAR(255) DEFAULT NULL, small_thumbnail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE review (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, livres_id INT DEFAULT NULL, commentaire VARCHAR(255) NOT NULL, date_review DATETIME NOT NULL, rating INT NOT NULL, INDEX IDX_794381C667B3B43D (users_id), INDEX IDX_794381C6EBF07F38 (livres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
